...
if platform.system() == "Windows":
    # winget install (fallback) — added first so D:\AI\ffmpeg takes priority
    if _WINGET_FFMPEG.exists():
        _KNOWN_BIN_PATHS.append(_WINGET_FFMPEG)
    # D:\AI\ffmpeg (custom install, preferred)
    _AI_FFMPEG = Path("D:/AI/ffmpeg")
    if _AI_FFMPEG.exists():
        _KNOWN_BIN_PATHS.append(_AI_FFMPEG)
